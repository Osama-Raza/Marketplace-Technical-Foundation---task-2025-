...
{/* ============ Product 1 ================= */}
            ...
            <div>
                <img src="../pots.jpg" alt="chair" className='h-[17rem] w-[19rem] hover:scale-105' />
                <h4 className='text-[#2a254b] font-normal text-xl mt-4'>The Dandy chair</h4>
                <p  className='text-[#2a254b] font-normal text-lg'>£250</p>
            </div>
            ...
            <div>
                <img src="../jug.jpg" alt="chair" className='h-[17rem] w-[19rem] hover:scale-105' />
                <h4 className='text-[#2a254b] font-normal text-xl  mt-4'>The Dandy chair</h4>
                <p  className='text-[#2a254b] font-normal text-lg'>£250</p>
            </div>
            ...
            <div>
                <img src="../lamp.jpg" alt="chair"  className='h-[17rem] w-[19rem] hover:scale-105'/>
                <h4 className='text-[#2a254b] font-normal text-xl mt-4'>The Dandy chair</h4>
                <p  className='text-[#2a254b] font-normal text-lg'>£250</p>
            </div>
